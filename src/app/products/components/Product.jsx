...
const Product = ({ title, id, desc, brand, thumbnail, price }) => {
  return (
    <Link
      href={`/products/${id}`}
      className="sm:w-60 w-4/5 mx-auto flex flex-col shadow-2xl gap-3 p-2 rounded-lg bg-white text-black cursor-pointer hover:scale-105 hover:border-black hover:border"
    >
